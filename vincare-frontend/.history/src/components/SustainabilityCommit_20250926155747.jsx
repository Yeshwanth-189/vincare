...
import "../styles/SustainabilityCommit.css";
import blueglobebluebg from "../assets/blue-globe-blue-bg.mp4";
      ...
      <div className="sust__com__grid">
        ...
        <div className="sust__content">
          ...
          <header className="sust__header">
            <h2
              ref={headingRef}
              className="sust__com__title slide_com-in slide_com-in--visible "
            >
              {title}
            </h2>
          </header>
          ...
          <div className="sust__twoCol">
            ...
            <div className="sust__left">
              <p className="sust__com__intro">
                <span className="sust__com__highlight">Vincare</span> is
              ...
              <div className="sust__safe__callout">
                <div className="sust__safe__calloutHead">
                  ...
                  <h2 className="sust__safe__safe__calloutTitle">
                    Our Commitment
                  </h2>
                </div>

                <p className="sust__safe__calloutText">
                  At Vincare, we are dedicated to green innovation and
                  sustainable growth. Through ongoing R&D in green chemistry, we
                  deliver eco-conscious formulations that raise industry
                  standards and drive meaningful change. By building
                  partnerships for sustainable practices, we ensure our
                  solutions remain effective today and responsible for
                  tomorrow’s world.
                </p>
              </div>
            </div>
