...
export default function Sustainability({
  ...
  <p className="sust__intro">
    Vincare is dedicated to driving sustainability through innovation, responsible
    sourcing, and eco-friendly operations. We focus on expanding the use of
    biodegradable formulations, promoting recyclable and reusable packaging, and
    adopting energy-efficient processes across our value chain. Our R&amp;D team
    continues to pioneer green chemistry solutions, while we reinforce strict
    compliance with safety and environmental standards. By engaging with partners,
    clients, and communities, we aim to advance a circular economy and minimize
    ecological impact. In alignment with global sustainability goals, we measure
    progress through transparent benchmarks — ensuring our growth remains clean,
  ...
  {[0, 1, 2, 3].map((i) => (
    <article key={i} className="sust__card">
      ...
      <ul className="sust__points">
        <li>Low-waste, energy-efficient production</li>
        <li>Reduced emissions &amp; carbon footprint</li>
      </ul>
    </article>
  ))}
</div>
