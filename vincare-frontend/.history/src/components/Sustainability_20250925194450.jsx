            ...
            <div className="sust__left">
              ...
              <article className="sust__card">
                ...
                <p className="sust__cardPara">
                  At <p className="sust__highlight">Vincare</p>, our
                  manufacturing practices are built on the foundation of
                  sustainability and efficiency. By embracing low-waste,
                  energy-efficient production methods, we optimize resources
                  while minimizing operational impact. Our facilities are
                  designed to reduce emissions and lower our overall carbon
