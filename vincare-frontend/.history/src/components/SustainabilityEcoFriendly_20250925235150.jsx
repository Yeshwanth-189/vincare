      ...
      <div className="sust__eco__grid">
        ...
        <div className="sust__content">
          ...
          <header className="sust__header">
            <h2
              ref={headingRef}
              className="sust__eco__title slide_eco-in slide_eco-in--visible "
            >
              {title}
            </h2>
          </header>
          ...
          <div className="sust__twoCol">
            ...
            <div className="sust__left">
              <p className="sust__eco__intro">
                <span className="sust__eco__highlight">Vincare</span> is
              ...
              <div className="sust__callout">
                <div className="sust__calloutHead">
                  ...
                  <h3 className="sust__calloutTitle">Eco Friendly Products</h3>
                </div>

                <p className="sust__calloutText">
                  At Vincare, we are committed to creating eco-friendly products
                  that are safe for both people and the planet. Our formulations
                  are developed with biodegradable and non-toxic ingredients,
                  ensuring effective cleaning without harmful residues. To
                  further reduce environmental impact, we use recyclable and
                  reusable packaging, supporting a circular economy and
                  promoting responsible consumption. With every product, we
                  strive to combine high performance with sustainability,
                  delivering solutions that care for our customers and the
                  environment alike.
                </p>
              </div>
            </div>
