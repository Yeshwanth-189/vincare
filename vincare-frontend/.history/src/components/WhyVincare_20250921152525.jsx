...
import "../styles/WhyVincare.css"; // make sure path matches your project

// demo images (replace with real imports)
      ...
      <div className="why__rows">
        {items.map((it, idx) => (
          ...
          >
            ...
            {/* text card (placement handled by CSS nth-child) */}
            ...
            {/* image (placement handled by CSS nth-child) */}
