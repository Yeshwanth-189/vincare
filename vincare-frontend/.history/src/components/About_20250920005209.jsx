  ...
  return (
    <section className="who grid-12" ref={rootRef}>
      ...
      >
        ...
        focus on eco-friendly, biodegradable, and high-performance formulations,
        Vincare has become trusted name in the cleaning and hygiene industry.
        Our diverse product range spans floor care, disinfectants, degreasers,
        and specialized solutions for healthcare, hospitality, education, and
        corporate sectors. Our diverse product range spans floor care,
        disinfectants, degreasers, and specialized solutions for healthcare,
        hospitality, education, and corporate sectors. Today, Vincare products
        clean and disinfect over 200 million sq. ft. daily, supported by 20+
        distributors and trusted by 80+ corporate clients nationwide. At the
        core of our success is a commitment to quality, sustainability, customer
        satisfaction, and innovation. Every formulation is developed under
        stringent standards, ensuring safety, reliability, and
        international-level performance. As a client-centric company, we deliver
        Hi-Tech services, on-time delivery, and customized solutions to meet
        evolving hygiene needs across industries.
      </motion.p>
...
>
  ...
  <div className="who__bandLeft">
    ...
    <p className="band__para">
      “To be a global leader in sustainable cleaning and hygiene solutions by
      delivering eco-friendly, innovative, and high-quality products that
      create healthier environments and enhance everyday living standards.”
    </p>

    <h4 className="band__subhead">
      <FaBullseye className="band__icon" />
      Our Mission
    </h4>
    <ul className="band__bullets">
      <li><FaCogs className="band__bulletIcon" /> <strong>Hi-Tech Service</strong> – Advanced, reliable cleaning solutions.</li>
      <li><FaClock className="band__bulletIcon" /> <strong>On-Time Delivery</strong> – Prompt, consistent, and efficient.</li>
      <li><FaAward className="band__bulletIcon" /> <strong>World-Class Quality</strong> – Safe, sustainable, and globally benchmarked.</li>
    </ul>
  </div>
  ...
  <div className="who__bandRight">
    ...
    <div className="band__valuesGrid">
      <div className="valueItem"><FaMedal className="valueIcon" /><span>Quality First</span></div>
      <div className="valueItem"><FaLeaf className="valueIcon" /><span>Sustainability</span></div>
      <div className="valueItem"><FaHandshake className="valueIcon" /><span>Customer Centricity</span></div>
      <div className="valueItem"><FaLightbulb className="valueIcon" /><span>Innovation</span></div>
      <div className="valueItem"><FaBalanceScale className="valueIcon" /><span>Integrity</span></div>
      <div className="valueItem"><FaShieldAlt className="valueIcon" /><span>Safety</span></div>
    </div>
  </div>
</motion.section>
  );
