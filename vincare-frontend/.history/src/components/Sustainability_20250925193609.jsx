              ...
              {[0, 1, 2, 3].map((i) => (
                <article className="sust__card">
                  ...
                  <p className="sust__cardPara">
                    ...
                    resources while minimizing operational impact. Our
                    facilities are designed to reduce emissions and lower our
                    overall carbon footprint, ensuring that every product we
                    create contributes not only to cleaner spaces but also to a
                    healthier planet.
                  </p>
                </article>
              ))}
