...
export default function WhoWeAreSection({ storyImg = AboutBg }) {
  ...
  return (
    <section className="who grid-12" ref={rootRef}>
      ...
      >
        <span className="who__highlight">Vincare</span> Founded in Bangalore
        Vincare Hygiene is a leading provider of housekeeping and water
        treatment solutions. With strong focus on eco-friendly, biodegradable,
        and high-performance formulations, Vincare has become a trusted name in
        the cleaning and hygiene industry.Our diverse product range spans floor
        care, disinfectants, degreasers, and specialized solutions for
        healthcare, hospitality, education, and corporate sectors.
      </motion.p>
