...
export default function Hero({
  title = "Vincare",
  subtitle = "One Stop Solution for All Hygiene Products",
  text = "We help you build reliable data platforms, scalable AI, and measurable outcomes—end to end.",
  primaryCta = { label: "View Services", href: "#" },
