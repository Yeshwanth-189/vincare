  ...
  return (
    <section className="why grid-12">
      ...
      <div className="why__rows">
        {items.map((it, idx) => {
          const isEvenIndex = idx % 2 === 1; // 0-based: 1,3,5... are "even-numbered" visually
          // For "even-numbered" rows: image left, text right
          const imgSide = isEvenIndex ? "left" : "right";
          const cardSide = isEvenIndex ? "right" : "left";
          ...
          return (
            ...
            >
              ...
              <div className={`why__cardWrap why__cardWrap--${cardSide}`}>
              ...
              <div className={`why__imgCol why__imgCol--${imgSide}`}>
