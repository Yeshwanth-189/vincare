...
export default function Sustainability({
  ...
  return (
            ...
            <div className="sust__right">
              <div className="sust__videoWrap">
                <video
                  ...
                  src={video<div className="sust__callout">
    ...
    <p className="sust__calloutText">
      At Vincare, our manufacturing practices are built on the foundation of
      sustainability and efficiency. By embracing low-waste, energy-efficient
      production methods, we optimize resources while minimizing operational
      impact. Our facilities are designed to reduce emissions and lower our
      overall carbon footprint, ensuring that every product we create contributes
