      ...
      >
        ...
        <div className="who__bandLeft">
          ...
          <div className="band__bullets">
            <div>
              <MdCheckCircleOutline className="band__bulletIcon" /> Hi-Tech
              Service – Advanced, reliable cleaning solutions.
            </div>
            <div>
              <MdCheckCircleOutline className="band__bulletIcon" /> On-Time
              Delivery – Prompt, consistent, and efficient.
            </div>
            <div>
              <MdCheckCircleOutline className="band__bulletIcon" /> World-Class
              Quality – Safe, sustainable, and globally benchmarked.
            </div>
          </div>
        </div>
