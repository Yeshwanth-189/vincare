...
import AboutBg from "../assets/About-bg-bg.png";
...
import WhyVincare from "./WhyVincare";
...
export default function WhoWeAreSection({ storyImg = AboutBg }) {
  ...
  const values = [
    { icon: FaMedal, label: "Quality First" },
    { icon: FaLeaf, label: "Sustainability" },
    { icon: FaHandshake, label: "Customer Centricity" },
  ...
  return (
    <>
      <section className="who grid-12" ref={rootRef}>
        ...
        >
          <span className="who__highlight">Vincare Hygiene</span> is a leading
          provider of housekeeping and water treatment solutions. Established in
          2003 with strong focus on eco-friendly, biodegradable, and
          high-performance formulations, Vincare has become trusted name in the
          cleaning and hygiene industry. Our diverse product range spans floor
          care, disinfectants, degreasers, and specialized solutions for
          healthcare, hospitality, education, and corporate sectors. Our diverse
          product range spans floor care, disinfectants, degreasers, and
          specialized solutions for healthcare, hospitality, education, and
          corporate sectors. Today, Vincare products clean and disinfect over
          200 million sq. ft. daily, supported by 20+ distributors and trusted
          by 80+ corporate clients nationwide. At the core of our success is a
      ...
      >
        ...
        <div className="who__bandLeft">
          ...
          <div className="band__bullets">
            <div>
              <MdCheckCircleOutline className="band__bulletIcon" />{" "}
        ...
        <div className="who__bandRight">
          <h3 className="band__eyeline">
            <FaReact className="band__icon" />
            Our Values
          </h3>
          <div className="band__valuesGrid">
            {values.map(({ icon: Icon, label }) => (
              <div className="valueItem" key={label}>
                <div className="valueIconWrap">
                  <Icon className="valueIcon" />
                </div>
