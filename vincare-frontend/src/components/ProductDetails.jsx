 ...
 * - Right: product preview area (cols 6–12)
 *
 * Props:
 *  product: {
 *    name: string,
...
export default function ProductDetails({ product }) {
  ...
  const hasPreview = Boolean(model);

  return (
    <section
      className="productDetails"
      style={{
        "--pd-bg": backgroundImage ? `url(${backgroundImage})` : "none",
      }}
    ...
    >
      ...
      <div className="productDetails__container">
        <div className="productDetails__card">
          {/* LEFT */}
          <div
            className={`productDetails__left ${
              !hasPreview ? "productDetails__left--full" : ""
            }`}
          >
          ...
          {/* RIGHT */}
          {hasPreview ? (
            <div className="productDetails__right" aria-label="Product preview">
              <div className="productDetails__viewerFrame">
                <div className="productDetails__viewerTop">
                  <span className="productDetails__viewerPill">
                    Product Preview
                  </span>
                ...
                <div className="productDetails__viewer">
                  {model?.type === "image" && model.src ? (
                    <img
                      ...
                      src={model.src}
                      alt={model.alt || `${name} product image`}
                    />
                  ) : null}
              ...
              <div className="productDetails__miniStat">
                ...
                <p className="productDetails__miniValue">{meta?.use || "-"}</p>
              </div>
              <div className="productDetails__miniStat">
                <p className="productDetails__miniLabel">Type</p>
                <p className="productDetails__miniValue">
                  {meta?.type || "-"}
                </p>
              </div>
              </div>
