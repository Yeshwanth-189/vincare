    ...
    >
      ...
      >
        <div className="productsIntro__content">
          <motion.h2 className="productsIntro__title" variants={item}>
            Our Products
          </motion.h2>

          <motion.p className="productsIntro__text">
          ...
          <motion.div className="productsIntro__cta" variants={item}>
            {/* Swap <a> with <Link to={href}> if using React Router */}
            <motion.a
              className="btn btn--outlineWhite"
              href={href}
              whileHover={
                reduce
                  ? {}
                  : {
                      y: -2,
                      boxShadow:
                        "0 10px 22px rgba(0,0,0,0.22), 0 0 0 4px rgba(255,255,255,0.15)",
                      transition: {
                        type: "spring",
                        stiffness: 300,
                        damping: 22,
              ...
              whileTap={reduce ? {} : { scale: 0.985, y: 0 }}
            >
              View Products
            </motion.a>
          </motion.div>
